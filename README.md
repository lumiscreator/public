...
Download the Latest supported v14

Disable Windows Firewall (Optional, try disabling if you can't see other players avatars but it works for me when enabled)
